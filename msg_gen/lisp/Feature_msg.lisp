...
(cl:in-package pf_drone_state_estimation-msg)
...
(cl:defclass <Feature_msg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (f
    :reader f
    :initarg :f
    :type pf_drone_state_estimation-msg:Feature_Keypoint
    :initform (cl:make-instance 'pf_drone_state_estimation-msg:Feature_Keypoint))
   (posX
    :reader posX
    :initarg :posX
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <Feature_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Feature_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pf_drone_state_estimation-msg:<Feature_msg> is deprecated: use pf_drone_state_estimation-msg:Feature_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:header-val is deprecated.  Use pf_drone_state_estimation-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'px-val :lambda-list '(m))
(cl:defmethod px-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:px-val is deprecated.  Use pf_drone_state_estimation-msg:px instead.")
  (px m))

(cl:ensure-generic-function 'py-val :lambda-list '(m))
(cl:defmethod py-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:py-val is deprecated.  Use pf_drone_state_estimation-msg:py instead.")
  (py m))

(cl:ensure-generic-function 'f-val :lambda-list '(m))
(cl:defmethod f-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:f-val is deprecated.  Use pf_drone_state_estimation-msg:f instead.")
  (f m))

(cl:ensure-generic-function 'posX-val :lambda-list '(m))
(cl:defmethod posX-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:posX-val is deprecated.  Use pf_drone_state_estimation-msg:posX instead.")
  (posX m))

(cl:ensure-generic-function 'posY-val :lambda-list '(m))
(cl:defmethod posY-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:posY-val is deprecated.  Use pf_drone_state_estimation-msg:posY instead.")
  (posY m))

(cl:ensure-generic-function 'posZ-val :lambda-list '(m))
(cl:defmethod posZ-val ((m <Feature_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:posZ-val is deprecated.  Use pf_drone_state_estimation-msg:posZ instead.")
  (posZ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Feature_msg>)))
  ...
  "pf_drone_state_estimation/Feature_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Feature_msg)))
  "Returns string type for a message object of type 'Feature_msg"
  "pf_drone_state_estimation/Feature_msg")
