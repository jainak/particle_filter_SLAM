...
(cl:defclass <Measurement_data> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (features
    :reader features
    :initarg :features
    :type (cl:vector pf_drone_state_estimation-msg:Feature_msg)
   :initform (cl:make-array 0 :element-type 'pf_drone_state_estimation-msg:Feature_msg :initial-element (cl:make-instance 'pf_drone_state_estimation-msg:Feature_msg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Measurement_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Measurement_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pf_drone_state_estimation-msg:<Measurement_data> is deprecated: use pf_drone_state_estimation-msg:Measurement_data instead.")))
...
(cl:defmethod features-val ((m <Measurement_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pf_drone_state_estimation-msg:features-val is deprecated.  Use pf_drone_state_estimation-msg:features instead.")
  (features m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Measurement_data>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'features)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pf_drone_state_estimation-msg:Feature_msg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Measurement_data>)))
  ...
  "pf_drone_state_estimation/Measurement_data")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Measurement_data)))
  "Returns string type for a message object of type 'Measurement_data"
  "pf_drone_state_estimation/Measurement_data")
